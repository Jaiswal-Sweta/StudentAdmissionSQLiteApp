...
class Admin_StudentListViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        StudentArray = SQLiteHandler.shared.fetchStudent()
...
extension Admin_StudentListViewController :UITableViewDataSource,UITableViewDelegate {
    ...
    @objc func OnSearchClicked()
    {
        ...
        {
            StudentArray = SQLiteHandler.shared.fetchStudentClasswise(SClass: SearchTextField.text ?? "")
        }
        else
        {
               StudentArray = SQLiteHandler.shared.fetchStudent()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "\(st.Spid) | \(st.Name) | \(st.Class)"
        return cell
    }
