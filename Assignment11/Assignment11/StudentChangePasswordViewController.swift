...
class StudentChangePasswordViewController: UIViewController {
    ...
    {
        SQLiteHandler.shared.ChangePassword(Password: PasswordTextfield.text!, Spid: UserDefaults.standard.integer(forKey: "SpidUser")) { (Sucess) in
            ...
            {
                let alert = UIAlertController(title: self.title, message: "Invalid Credentials",preferredStyle: .alert)
